...
Strict table mapping rules: Column 1 is labels only: “Competency”, “Suggested Learning Material/Reference”, “Learning Activities/Tasks”. Columns 2–6 are Monday to Friday (in that order). Output JSON only with keys competency, references, activities and days mon..fri.`;
    ...
    function generateTemplate(comp: string): string {
      const template = {
        ...
        activities: {
          mon: `Introduce and explore the fundamental concepts of ${comp} through guided instruction. Assessment Questions (Identification): 1. What is the main concept being studied in this competency? 2. Identify the key components that make up this topic. 3. Name the primary objective of learning this competency. 4. What are the essential skills needed for this subject area? 5. Identify how this competency connects to your daily life. Expected Output: Completed identification worksheet and learning goals list. Contingency: Independent reading and concept mapping during class suspension.`,
          tue: `Develop deeper understanding of ${comp} through structured practice and application. Assessment Questions (Multiple Choice): 1. Which statement best describes the main concept? A) A basic skill B) An advanced theory C) A practical application D) All of the above 2. The most effective way to master this competency is: A) Memorization only B) Practice and application C) Reading textbooks D) Listening to lectures 3. This competency is most closely related to: A) Previous lessons B) Real-world situations C) Future topics D) All of these 4. The primary benefit of learning this is: A) Academic success B) Personal development C) Career preparation D) All of the above 5. Which approach works best for understanding: A) Individual study B) Group collaboration C) Hands-on practice D) All methods combined. Expected Output: Multiple choice answer sheet with explanations. Contingency: Online modules and practice exercises.`,
          wed: `Apply knowledge of ${comp} through practical activities and real-world connections. Assessment Questions (True or False): 1. This competency can be applied in everyday situations. 2. Understanding this topic requires only theoretical knowledge. 3. Collaborative learning enhances comprehension of this subject. 4. This competency builds upon previously learned concepts. 5. Mastering this skill will help in future learning. Expected Output: True/False response sheet with justifications. Contingency: Research-based learning activities and documentation.`,
          thu: `Strengthen mastery of ${comp} through problem-solving and critical analysis. Assessment Questions (Identification): 1. Identify the most challenging aspect of this competency and explain why. 2. What problem-solving strategies work best for this topic? 3. Name three real-world situations where you would use this knowledge. 4. Identify the key indicators that show you understand this competency. 5. What additional skills complement this learning area? Expected Output: Problem-solving portfolio and strategy documentation. Contingency: Independent practice problems with detailed solutions.`,
          fri: `Synthesize and evaluate understanding of ${comp} through comprehensive assessment. Assessment Questions (Essay/Short Answer): 1. Summarize the most important concepts you learned about this competency this week. 2. Explain how this knowledge will be useful in your future studies and career. 3. Describe the learning process that worked best for you and why. 4. What connections can you make between this competency and other subjects you're studying? 5. Create a brief teaching plan to help a classmate learn this topic. Expected Output: Reflection essay and peer teaching materials. Contingency: Comprehensive review assignment and self-assessment rubric.`
        }
      };
