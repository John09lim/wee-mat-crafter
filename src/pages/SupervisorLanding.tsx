    ...
    try {
      if (mode === "signup") {
        ...
        if (!roleData) {
          ...
          const message = "Access denied. This login is for supervisors only.";
          setFormError(message);
          toast.error(message);
          setLoading(false);
          return;
    ...
    >
      {mode === "signup" ? (
        <>
          ...
          />
          <AuthField
            id="supervisor-landing-district"
            name="address-level2"
            label="District name"
            icon={MapPin}
            value={district}
      ...
      <AuthField
        ...
        autoComplete="email"
        helper="Use the email connected to your district record."
        required
      />

      {mode !== "reset" ? (
        <AuthField
          id="supervisor-landing-password"
          name="password"
          label="Password"
          icon={Lock}
          type="password"
      ...
      {mode === "signup" ? (
        <AuthField
          id="supervisor-landing-password-confirmation"
